...
@section('content')
    ...
    <div class="container-fluid mt-3">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 text-primary"><i class="fas fa-calendar-day"></i> Bank Details (Daily View)</h4>
            <div id="topActionButtons">
                ...
                <button class="btn btn-success btn-sm d-none shadow-sm" id="btnExport"><i class="fas fa-file-excel"></i>
                    Excel</button>
                <button class="btn btn-dark btn-sm d-none shadow-sm" id="btnPrint"><i class="fas fa-print"></i>
                    Print</button>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="d-block d-md-none">
                    <div class="mb-3 p-2 bg-light rounded">
                        <input type="checkbox" id="selectAllMobile"> <label for="selectAllMobile" class="fw-bold">Select
                            All</label>
                    </div>
        ...
        <div id="floatingActionBar"
            class="fixed-bottom bg-danger p-3 text-white d-none shadow-lg d-flex justify-content-between align-items-center"
            style="z-index: 1050; opacity: 0.95;">
            <span id="selectedCount" class="fw-bold">0 items selected</span>
            <button class="btn btn-light btn-sm fw-bold" id="btnBulkDelete" onclick="deleteSelectedPermanent()"><i
...
@push('scripts')
    ...
    <script>
        ...
        // RBAC Configuration (Daily View uses 'bank_')
        const rbacPrefix = 'bank_';
        const apiUrl = '/api/v1/bank-details/daily';
        ...
        $(document).ready(function() {
            ...
            // Fix Custom Export/Print Buttons Triggering DataTables
        ...
        function applyRbacUI() {
            ...
            let isGod = userContext.is_god || userContext.role_level === 'ceo';

            if (isGod || perms.includes(rbacPrefix + 'add_direct')) $('#btnAddDirect').removeClass('d-none');
            if (!isGod && perms.includes(rbacPrefix + 'add_request')) $('#btnAddRequest').removeClass('d-none');
            if (isGod || perms.includes(rbacPrefix + 'export')) $('#btnExport').removeClass('d-none');
            if (isGod || perms.includes(rbacPrefix + 'print')) $('#btnPrint').removeClass('d-none');
            if (isGod || perms.includes(rbacPrefix + 'delete')) $('#btnBulkDelete').removeClass('d-none');
        }
