        ...
        $(document).ready(function() {
            ...
            let table = $('#lhTable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'emp_code',
                        render: d => `<span class="badge bg-secondary">${d||'N/A'}</span>`
                    },
                    {
                        data: 'subject',
                        render: d => d || '-'
            ...
            `;
                ...
                $('#mobileCardsContainer').html(html ||
                    '<p class="text-center text-muted">No Letterheads found.</p>');
                if (typeof window.applyPermissions === 'function') window.applyPermissions();
            }
            ...
            function loadDependencies() {
                ...
                $.get({
                    ...
                    success: function(res) {
                        ...
                        res.data.forEach(e => dlHtml +=
                            `<option value="${e.member_id}">${e.full_name}</option>`);
