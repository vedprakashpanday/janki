        ...
        <div class="col-md-8 col-lg-6">
            <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold text-secondary">Search Name or ID <span class="text-danger">*</span></label>
                        <input type="text" id="staff_input" class="form-control form-control-lg bg-light" list="staffList" placeholder="Type to search..." autocomplete="off">
                    ...
                    <div id="actionButtons" style="display: none;">
                        ...
                        <div class="d-grid gap-3">
                            ...
                            <button class="btn btn-outline-primary btn-lg fw-bold print-btn bg-white" data-type="visiting_normal">
...
$(document).ready(function() {
    ...
    $('.print-btn').on('click', function() {
        ...
        window.open(`/admin/id-cards/print/${type}/${id}`, '_blank');
    });
});
</script>
@endpush